...
private static     List<Producto> productos=new ArrayList<>();/*Se hace estaticos para poder crear una lista de productos que pertenezca a la clase y no alas instancias*/
